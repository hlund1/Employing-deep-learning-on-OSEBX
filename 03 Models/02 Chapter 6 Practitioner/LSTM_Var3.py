...
input_data = np.load('01 Data/02 Preprocessed data/input data LSTM_Var3.npy')
...
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 prob/LSTM_Var3 prob.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 class/LSTM_Var3 class.csv', predicted_returns_class, delimiter=",")
