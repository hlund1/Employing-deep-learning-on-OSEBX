...
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 prob/LSTM_Standard prob.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 class/LSTM_Standard class.csv', predicted_returns_class, delimiter=",")
