...
input_data = np.load('01 Data/02 Preprocessed data/input data LSTM_Var3D.npy')
...
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 prob/LSTM_Var3D prob.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 class/LSTM_Var3D class.csv', predicted_returns_class, delimiter=",")
