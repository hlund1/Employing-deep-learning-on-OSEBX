...
input_data = np.load('01 Data/02 Preprocessed data/input data LSTM_Var8D.npy')
...
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 prob/LSTM_Var8D prob.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/02 Chapter 6 Practitioner/01 class/LSTM_Var8D class.csv', predicted_returns_class, delimiter=",")
