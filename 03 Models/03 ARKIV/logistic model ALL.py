...
# Create 18 study periods of 1000 days, with train and test sets
return_window = []
return_window_y = []
days = 1000
...
regressor = LogisticRegression(C=0.01, solver='lbfgs')
...
np.savetxt('121218 logistic pred prob ALL.csv', predicted_returns_prob, delimiter=",")
np.savetxt('121218 logistic pred class ALL.csv', predicted_returns_class, delimiter=",")
