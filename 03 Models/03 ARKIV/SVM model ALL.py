...
#Defining classifier:
regressor = svm.SVC(C = 100, kernel = 'rbf', gamma = 0.01, probability = True)
i = 0
...
np.savetxt('121218 SVM pred prob ALL.csv', predicted_returns_prob, delimiter=",")
np.savetxt('121218 SVM pred class ALL.csv', predicted_returns_class, delimiter=",")
