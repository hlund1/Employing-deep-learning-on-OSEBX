...
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 prob/5 lstm_a prob.csv.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 class/5 lstm_a class.csv.csv', predicted_returns_class, delimiter=",")