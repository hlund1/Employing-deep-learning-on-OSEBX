...
for i in range(0, len(return_window)):
    ...
    #------------------------ Looping over each stock individually --------------
...
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 prob/1 log prob.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 class/1 log class.csv', predicted_returns_class, delimiter=",")
