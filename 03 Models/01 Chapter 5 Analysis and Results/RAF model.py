...
classifier = RandomForestClassifier(n_estimators = 1000, max_features=1, max_depth=8, criterion = 'entropy', random_state = 0)
...
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 prob/2 raf prob.csv.csv', predicted_returns_prob, delimiter=",")
np.savetxt('04 Predictions/01 Chapter 5 Analysis and Results/01 class/2 raf class.csv.csv', predicted_returns_class, delimiter=",")